...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "v", function () awful.spawn("alacritty --title Ranger -e zsh -ic ranger") end,
    ...
    awful.key({ modkey,           }, "t", function () awful.spawn("st -n Transmission -e zsh -ic trm") end,
    ...
    awful.key({                   }, "Pause", function () os.execute("playerctl play-pause") end,
              {description = "Media play-pause", group = "Launcher"}),
    awful.key({ modkey, "Control" }, "space", function () awful.spawn("dymscript") end,
...
awful.rules.rules = {
    ...
    { rule = { instance = "Mathematica" },
      properties = { screen = screen_num, tag = "󰒠" } },
