...
vim.g.comment_map = { c = '//', cpp = '//', go = '//', java = '//', javascript = '//', lua = '%-%-', scala = '//', php = '//', python = '#', ruby = '#', rust = '//', sh = '#', desktop = '#', fstab = '#', conf = '#', profile = '#', bashrc = '#', bash_profile = '#', mail = '>', eml = '>', bat = 'REM', ahk = ';', vim = '', tex = '%%', yaml = '#', julia = '#' }
