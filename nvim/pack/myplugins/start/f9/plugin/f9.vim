let s:run_map = { "c": '!shstart -sn vimRunC', "html": '!brave --incognito --profile-directory="Profile 1"', "lua": '!lua', "python": '!python3', "rust": '!cargo run', "sh": '!bash', "conf": '!source', "profile": '!source', "bashrc": '!source', "bash_profile": '!source', "vim": 'source' }
